        ...
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/2 mb-8 md:mb-0 md:pl-0 lg:pl-0">
            ...
            <div className="mt-6">
              ...
              >
                CONTACT US
                <svg className="ml-3" width="24" height="24" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M17 9L1 1L3 9M17 9L1 17L3 9M17 9H3" stroke="#F7F7F7" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </Link>
            </div>
          </div>
          <div className="md:w-1/2 flex justify-end">
            <div className="relative w-full h-80 md:h-96 lg:h-[400px]">
              <div className="absolute right-0 top-0 md:-top-16 md:right-8 lg:right-26">
                <svg width="380" height="380" viewBox="0 0 330 330" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle opacity="0.4" cx="165" cy="165" r="165" fill="#3F8499"/>
                </svg>
              </div>
