  ...
  return (
    <div className="payment-form-container">
      ...
      <form>
        ...
        <div className="mb-6">
          <label className="block text-sm font-medium text-[#999999] mb-3">Complete your purchase by providing your payment details</label>
            ...
            {paymentMethods.map(method => (
              ...
              >
                <img 
                  ...
                  className="h-6 mr-3" 
                />
                <span className={`text-sm font-medium ${paymentMethod === method.id ? 'text-white' : 'text-gray-800'}`}>
                  {method.name}
                </span>
              </div>
            ))}
