    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-6">
        ...
        >
          <div className="p-6 flex items-center gap-4 bg-opacity-40">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-xl font-semibold text-white">Portfolio {courseData.progress}% complete</p>
              ...
              <p className="text-base text-white">You're enrolled in the {courseData.track} track.</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#f5e5cc] p-6 md:w-58 flex flex-col items-center justify-center">
          <div className="flex items-center justify-center w-full gap-2 font-semibold text-[#ecb476] mb-5">
            ...
            <span className="text-2xl font-bold whitespace-nowrap">Daily Streak</span>
          </div>
          <div className="text-6xl font-semibold text-[#ecb476]">{courseData.streak}</div>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-3 mb-6">
        ...
        <div className="bg-[#F8E7CE] p-6 shadow-md flex-1">
          <p className="text-[#DDA853] uppercase font-semibold text-xl mb-2">LEARNING PATH</p>
          <div className="flex items-center mb-1">
            <h2 className="text-2xl font-bold text-gray-800 cursor-pointer flex items-center" onClick={() => document.getElementById('course-path-container').scrollIntoView({ behavior: 'smooth' })}>
              {courseData.title}
          ...
          <div className="flex flex-wrap items-center gap-4 mb-6">
            ...
            <div className="bg-[#ecd2aa] bg-opacity-50 rounded-md p-3 flex flex-col items-center w-40">
              <p className="text-gray-700 text-lg font-bold mb-1">Difficulty level</p>
              <p className="text-2xl font-bold">{courseData.difficulty}</p>
            </div>
            <div className="flex-1 max-w-sm">
              <div className="w-full bg-[#F7DBA7] rounded-full h-3 mb-1">
                <div className="bg-[#F59E0B] h-3 rounded-full" style={{ width: `${courseData.completionPercentage}%` }}></div>
              </div>
          ...
          <p className="text-gray-700 text-lg mb-6">
            Early Christian and Byzantine art blended Roman influences with Christian symbolism, focusing on spirituality over realism. Iconic mosaics, frescoes, and grand architecture like Hagia Sophia continue to shape religious and artistic traditions.
          </p>
        </div>
        
        {/* WHY you should learn section */}
        <div className="bg-[#f9f9f9] p-6 shadow-md md:w-1/3">
          <p className="text-[#DDA853] uppercase font-semibold text-sm mb-4">WHY YOU SHOULD LEARN?</p>
          <ul className="list-disc pl-5 space-y-1 text-gray-700 text-sm">
            <li>Unlimited access to this course in the Certificate</li>
            <li>Cancel anytime</li>
            <li>No invisible fees; you can cancel before the time ends if it's not right for you</li>
            <li>40,000 USD per month to continue learning and grow your skills</li>
            <li>Go as fast as you can - the faster you go, the more you save</li>
            <li>Certificate when you complete after your trial ends</li>
            <li>Share on your resume, LinkedIn, and CV</li>
          </ul>
          
          <Link to="#enroll" className="bg-[#e8ba70] text-black font-bold px-8 py-2 inline-flex items-center hover:bg-amber-600 transition-colors mt-6 w-full justify-center">
            Enroll in path
