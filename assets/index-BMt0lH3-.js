import{c as j,r as C,k as g,j as e,e as w,B as n,V as u,l as c,T as d,i as N}from"./index-Cccadl2F.js";import{C as z}from"./Completed-BaIUPoD3.js";import{A as k}from"./arrow-left-BVe0LcSD.js";import{A as y}from"./award-CMVmi5-a.js";/**
 ...
 */const A=[["path",{d:"M12 20h9",key:"t2du7b"}],["path",{d:"M16.376 3.622a1 1 0 0 1 3.002 3.002L7.368 18.635a2 2 0 0 1-.855.506l-2.872.838a.5.5 0 0 1-.62-.62l.838-2.872a2 2 0 0 1 .506-.854z",key:"1ykcvy"}]],x=j("pen-line",A);function I({moduleId:l,courseId:a,onBack:o}){var p;const[i,b]=C.useState("introduction"),m=g(),r={title:"Early Christian Art",sections:[{id:"introduction",title:"Introduction to Early Christian Art",type:"reading",completed:!0,hasCompletionButton:!0,content:`
        ...
        `}],duration:45,difficulty:"Intermediate"},f=t=>{alert(`Section "${t}" marked as complete!`)},v=((p=r.sections.find(t=>t.id===i))==null?void 0:p.content)||"",s=r.sections.find(t=>t.id===i),h=t=>{t==="quiz"?m(`/quiz/course/${a}/module/${l}`):t==="challenge"&&m(`/challenge/course/${a}/module/${l}`)};return e.jsxs("div",{className:"flex flex-col lg:flex-row bg-white rounded-lg shadow-md overflow-hidden",children:[e.jsxs("div",{className:"lg:w-1/4 border-r border-gray-200",children:[e.jsxs("div",{className:"bg-amber-50 p-4 border-b border-amber-100",children:[e.jsxs("button",{onClick:o,className:"flex items-center text-[var(--color-primary-yellow)] hover:text-[var(--color-secondary-yellow)] mb-2",children:[e.jsx(k,{size:16,className:"mr-1"}),e.jsx("span",{children:"Back to Course"})]}),e.jsx("h1",{className:"text-lg font-bold text-[var(--color-primary-yellow)]",children:r.title})]}),e.jsxs("div",{className:"p-4 border-b border-gray-200 text-sm text-gray-600",children:[e.jsxs("div",{className:"flex items-center mb-2",children:[e.jsx(w,{size:16,className:"mr-2 text-[var(--color-primary-yellow)]"}),e.jsxs("span",{children:[r.duration," minutes"]})]}),e.jsxs("div",{className:"flex items-center",children:[e.jsx(n,{size:16,className:"mr-2 text-[var(--color-primary-yellow)]"}),e.jsxs("span",{children:["Difficulty: ",r.difficulty]})]})]}),e.jsxs("div",{className:"p-2",children:[e.jsx("h3",{className:"px-2 py-1 text-sm font-medium text-gray-500 uppercase",children:"Module Content"}),e.jsx("nav",{className:"mt-2",children:r.sections.map(t=>e.jsxs("button",{onClick:()=>{b(t.id)},className:`w-full text-left px-4 py-3 flex items-center ${i===t.id?"bg-amber-50 text-[var(--color-primary-yellow)] border-l-2 border-[var(--color-primary-yellow)]":"text-gray-700 hover:bg-gray-50"}`,children:[e.jsx("div",{className:"mr-2",children:e.jsx(z,{isCompleted:t.completed,size:16})}),e.jsx("div",{className:"mr-2 text-[var(--color-primary-yellow)]",children:t.type==="reading"?e.jsx(n,{size:16}):t.type==="video"?e.jsx(u,{size:16}):t.type==="quiz"?e.jsx(x,{size:16}):e.jsx(y,{size:16})}),e.jsx("span",{children:t.title})]},t.id))})]})]}),e.jsxs("div",{className:"lg:w-3/4",children:[e.jsx("div",{className:"bg-white p-6 border-b border-gray-200",children:e.jsxs("div",{className:"flex items-center",children:[(s==null?void 0:s.type)==="reading"?e.jsx(n,{size:20,className:"mr-3 text-[var(--color-primary-yellow)]"}):(s==null?void 0:s.type)==="video"?e.jsx(u,{size:20,className:"mr-3 text-[var(--color-primary-yellow)]"}):(s==null?void 0:s.type)==="quiz"?e.jsx(x,{size:20,className:"mr-3 text-[var(--color-primary-yellow)]"}):e.jsx(y,{size:20,className:"mr-3 text-[var(--color-primary-yellow)]"}),e.jsx("h2",{className:"text-xl font-bold text-gray-800",children:s==null?void 0:s.title})]})}),e.jsxs("div",{className:"p-6",children:[e.jsx("div",{dangerouslySetInnerHTML:{__html:v}}),e.jsxs("div",{className:"mt-8",children:[(s==null?void 0:s.type)==="quiz"&&e.jsx(c,{onClick:()=>h("quiz"),className:`${d.HIGHLIGHT_FRAME} px-6 py-2 rounded-md`,children:"Start Quiz"}),(s==null?void 0:s.type)==="challenge"&&e.jsx(c,{onClick:()=>h("challenge"),className:`${d.HIGHLIGHT_FRAME} px-6 py-2 rounded-md`,children:"Begin Challenge"}),(s==null?void 0:s.hasCompletionButton)&&e.jsx(c,{onClick:()=>f(s.id),className:`${d.HIGHLIGHT_FRAME} px-6 py-2 rounded-md`,children:"Mark as Complete"})]})]})]})]})}function M(){const{courseId:l,moduleId:a}=N(),o=g(),i=()=>{o(`/learn/course/${l}`)};return e.jsx("div",{className:"w-full px-4",children:e.jsx("div",{className:"max-w-7xl mx-auto flex flex-col gap-6",children:e.jsx(I,{moduleId:parseInt(a),courseId:l,onBack:i})})})}export{M as default};
